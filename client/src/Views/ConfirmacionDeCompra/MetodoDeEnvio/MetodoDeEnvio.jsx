...
const MetodoDeEnvio = ( { userBuyData, setUserBuyData, setView } ) => {
    ...
    return (
        <form onSubmit={formik.handleSubmit} >
            <label htmlFor="oca">
                <input type="radio" name="metodoDeEnvio" id="oca" value="OCA" onChange={formik.handleChange} checked={formik.values.metodoDeEnvio === "OCA"}/>
                Oca
            </label>

            <label htmlFor="correoArgentino">
                <input type="radio" name="metodoDeEnvio" id="correoArgentino" value="Correo Argentino" onChange={formik.handleChange} checked={formik.values.metodoDeEnvio === "Correo Argentino"}/>
                Correo Argentino
            </label>
